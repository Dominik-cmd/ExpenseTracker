...
@Component({
  ...
  imports: [
    DatePipe, FormsModule, ButtonModule, CardModule, CheckboxModule,
              ...
              <tr>
                ...
                <td>
                  @if (user.isAdmin) {
                    ...
                    <p-tag severity="info" value="User"></p-tag>
                  }
                </td>
...
export class UserManagementComponent implements OnInit {
  ...
  protected createUser(): void {
    ...
    this.adminService.createUser({ username: this.newUsername, password: this.newPassword, isAdmin: this.newIsAdmin }).pipe(
